...
def ask_agent():
    ...
    decision_prompt = f"""
                    You are a stock market routing assistant.

                    User Query:
                    {query}

                    Your task is to decide which backend function should be called.

                    Rules:
                    1. Respond with EXACTLY one line.
                    2. Do NOT explain your answer.
                    3. Do NOT generate code.
                    4. Do NOT use markdown.
                    5. Do NOT use backticks.
                    6. Do NOT use quotes.
                    7. Return ONLY one of the following formats:

                    CALL get_stock_price STOCK_TICKER
                    CALL analyze_stock STOCK_TICKER
                    CALL get_stock_range STOCK_TICKER
                    CALL compare_stocks STOCK_TICKER1 STOCK_TICKER2
                    UNKNOWN

                    IMPORTANT:
                    - Always return VALID STOCK TICKER SYMBOLS, never company names.
                    - Examples:
                    - Apple -> AAPL
                    - Microsoft -> MSFT
                    - Nvidia -> NVDA
                    ...
                    User: Give me the support and resistance of Tesla
                    Output:
                    CALL get_stock_range TSLA

                    User: Compare Apple and Nvidia
                    Output:
                    CALL compare_stocks AAPL NVDA

                    User: Compare Microsoft with Amazon
                    Output:
                    CALL compare_stocks MSFT AMZN
